...
#
#
#Place this into your ~/bin and make it executable using ->
#   
#   chmod +x mp3d.py
#   
#Then simply download a song by doing ->
#
#   mp3d.py <name of song>
#
# Example ->
#
# mp3d.py Coldplay Yellow
#
# Type the name of song, as you would search for it on youtube
